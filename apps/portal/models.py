...
class Classes(models.Model):
    ...
    teaccher = models.ForeignKey('Teachers', models.DO_NOTHING)
...
class Students(models.Model):
    ...
    reg_no = models.CharField(unique=True, max_length=50, blank=True, null=True)
...
class Teachers(models.Model):
    ...
    surname = models.CharField(max_length=50)
    email = models.CharField(unique=True, max_length=50, blank=True, null=True)
    staff_no = models.CharField(unique=True, max_length=50, blank=True, null=True)
